        ...
        while trainer.n_sentences < params.epoch_size:
            ...
            if params.lambda_xe_otfd > 0 or params.lambda_xe_otfa > 0:
                ...
                if use_gpu % 5 == 0:
                    ...
                    for em in back_direction:
                        lang1, lang2 = em[0], em[1]
                        lang1_id = params.lang2id[lang1]
                        lang2_id = params.lang2id[lang2]

                        with torch.no_grad():
                            sent1, len1 = trainer.get_batch('encdec', lang1, None)
                            encoded = trainer.encoder(sent1.cuda(), len1, lang1_id)
                            sent2, len2, _ = trainer.decoder.generate(encoded, lang2_id)
                            batch = {
                                'lang1':lang1, 'lang2':lang2, 'lang3': lang1,
                                'len1':len1, 'len2': len2, 'len3':len1,
                                'sent1': sent1, 'sent2': sent2 , 'sent3':sent1
                            }
